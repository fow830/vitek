...
func TestContract_HTTPSurface(t *testing.T) {
	require.Equal(t, tokens.HTTPPathAllowlist, []string{
		...
		tokens.PathV1MeWatches,
		tokens.HTTPPathID(tokens.PathV1MeWatches),
		tokens.HTTPPathMeWatchResults(),
		tokens.HTTPPathMeWatchResetBaseline(),
		tokens.PathV1ProxiesActive,
		tokens.PathV1AuthMagicLink,
		tokens.PathV1AuthMagicLinkConsume,
		tokens.PathV1AuthMagicLinkOpen,
		...
		tokens.PathV1AdminBindings,
		tokens.HTTPPathID(tokens.PathV1AdminBindings),
		tokens.HTTPPathAdminBindingSessionLogin(),
		tokens.PathV1MeNotifications,
		tokens.PathRoot,
		tokens.PathAppSSE,
