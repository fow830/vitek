...
const (
	...
	AppCopySearchLede       = "Вставьте ссылку на фильтр Avito — сервис проверяет новые объявления каждую минуту."
	AppCopySearchStatusWatch = "Мониторинг — проверка каждую минуту"
