...
var HTTPAppRoutes = []HTTPRouteSpec{
	...
	{Method: http.MethodPatch, Path: HTTPPathID(PathV1MeWatches)},
	{Method: http.MethodDelete, Path: HTTPPathID(PathV1MeWatches)},
	{Method: http.MethodPost, Path: HTTPPathMeWatchResetBaseline()},
	...
	{Method: http.MethodGet, Path: PathV1AdminBindings},
	{Method: http.MethodPost, Path: PathV1AdminBindings},
	{Method: http.MethodPatch, Path: HTTPPathID(PathV1AdminBindings)},
	{Method: http.MethodDelete, Path: HTTPPathID(PathV1AdminBindings)},
	{Method: http.MethodPost, Path: HTTPPathAdminBindingSessionLogin()},
	{Method: http.MethodGet, Path: PathV1MeNotifications},
	{Method: http.MethodPut, Path: PathV1MeNotifications},
	{Method: http.MethodGet, Path: PathRoot},
...
var HTTPPathAllowlist = []string{
	...
	PathV1MeTasks,
	PathV1MeWatches,
	HTTPPathID(PathV1MeWatches),
	HTTPPathMeWatchResults(),
	HTTPPathMeWatchResetBaseline(),
	PathV1ProxiesActive,
	PathV1AuthMagicLink,
	...
	PathV1AdminBindings,
	HTTPPathID(PathV1AdminBindings),
	HTTPPathAdminBindingSessionLogin(),
	PathV1MeNotifications,
	PathRoot,
	PathAppSSE,
	PathTokensCSS,
}
