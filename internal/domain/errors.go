...
var (
	...
	ErrWatchLimitExceeded        = errors.New(tokens.ErrMsgWatchLimit)
	ErrInvalidWatchStatus        = errors.New(tokens.ErrMsgInvalidWatchStatus)
	ErrListingSearchNoBinding    = errors.New(tokens.ErrMsgListingSearchNoBinding)
